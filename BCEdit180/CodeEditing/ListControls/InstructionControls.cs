...
namespace BCEdit180.CodeEditing.ListControls {
    ...
    public class LdcInstructionControl : BaseInstructionControl {
        public override void OnUserAction() {
    ...
    public class MultiANewArrayInstructionControl : BaseInstructionControl {}
    public class NewArrayInstructionControl : BaseInstructionControl {}
    public class SimpleInstructionControl : BaseInstructionControl {}
    public class StackMapFrameControl : BaseInstructionControl {}
    public class TableSwitchInstructionControl : BaseInstructionControl {}
    public class TypeInstructionControl : BaseInstructionControl {}
    public class VariableInstructionControl : BaseInstructionControl {}
}